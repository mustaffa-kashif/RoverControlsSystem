/*
 * Note: I could not use an Ethernet shield, so I was unable to test the Ethernet input functionality.
 * However, I have tried my best to implement Ethernet inputs to this project based on standard practices.
 */
#include <Arduino.h>
...
void loop()
{
    ...
    if (currentMode == SERIAL_MODE)
    {
        ...
        {                                         // If data is available on Serial
